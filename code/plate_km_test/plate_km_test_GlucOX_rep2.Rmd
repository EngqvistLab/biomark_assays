...
```{r}
assay.df <- read.table(paste(INTERMEDIATE, THIS_PROJECT_FOLDER, 'GlucOX_assay.tsv', sep='/'), sep='\t', header=TRUE, na.strings="")

sample.df <- read.table(paste(INTERMEDIATE, THIS_PROJECT_FOLDER, 'GlucOX_sample.tsv', sep='/'), sep='\t', header=TRUE, na.strings="")
